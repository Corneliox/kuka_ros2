...
EKI XML Serialization & Socket Layer (\texttt{kuka\_eki\_bridge}) \cite{kuka_external_control2023} & $36 \pm 9$ \\
\hline
...
Huber, M., Mower, C.E., Ourselin, S., Vercauteren, T., Bergeles, C.: LBR-Stack: ROS 2 and Python integration of KUKA FRI for Med and IIWA robots. Journal of Open Source Software 9(95), 6120 (2024). \url{https://doi.org/10.21105/joss.06120}

\bibitem{kuka_external_control2023}
Mehner, M., Matkovic, N., Muehlbeier, E., Mayer, D., Fleischer, J., Verl, A.: Evaluation of external control of KUKA Industrial Robots for laboratory and prototype environments. In: Proc. 56th International Symposium on Robotics (ISR Europe 2023), pp. 278--284. VDE Verlag (2023). \url{https://ieeexplore.ieee.org/document/10320498}

\bibitem{quirubot2012}
Perez-Vidal, C., Carpintero, E., Garcia-Aracil, N., Fernandez, E., Sabater-Navarro, J.M.: Steps in the development of a robotic scrub nurse. Robotics and Autonomous Systems 60(6), 901--911 (2012). \url{https://doi.org/10.1016/j.robot.2012.04.004}
...
Asha, C.S., D'Souza, J.M.: Voice-controlled object pick and place for collaborative robots employing the ROS 2 framework. In: Proc. 2024 International Conference on Advances in Modern Age Technologies for Health and Engineering Science (AMATHE), pp. 1--6. IEEE (2024). \url{https://doi.org/10.1109/AMATHE61642.2024.10620853}

\bibitem{rt2_2023}
Brohan, A., Brown, N., Carbajal, J., Chebotar, Y., Chen, X., Choromanski, K., Ding, T., Driess, D., Dubey, A., Finn, C., et al.: RT-2: Vision-Language-Action models transfer web knowledge to robotic control. In: Proc. 7th Conference on Robot Learning (CoRL), PMLR, vol. 229, pp. 2165--2183 (2023). \url{https://proceedings.mlr.press/v229/brohan23a.html}

\bibitem{openvla2024}
Kim, M.J., Pertsch, K., Balakrishna, A., Nair, S., Rafailov, R., Meng, K., Gehring, C., Julian, R., Finn, C., Levine, S.: OpenVLA: An open-source vision-language-action model. In: Proc. 8th Conference on Robot Learning (CoRL 2024), PMLR, vol. 270, pp. 2679--2713 (2025). \url{https://proceedings.mlr.press/v270/kim25e.html}
...
KUKA AG: KUKA System Software (KSS) 8.3 Operating and Programming Instructions for System Integrators. KUKA AG, Augsburg, Germany (2018). \url{https://www.kuka.com}

\bibitem{kuka_eki2019}
KUKA AG: KUKA.Ethernet KRL 3.1 Operating and Programming Instructions. KUKA AG, Augsburg, Germany (2019). \url{https://www.kuka.com}
...
Pilz GmbH \& Co. KG: Pilz Industrial Motion Planner for ROS and MoveIt 2. ROS-Industrial / ROSIN Open-Source Project (2021). \url{https://moveit.picknik.ai/main/doc/examples/pilz_industrial_motion_planner/pilz_industrial_motion_planner.html}

\bibitem{yolo2024}
Jocher, G., Chaurasia, A., Qiu, J.: Ultralytics YOLO. Ultralytics (2024). \url{https://github.com/ultralytics/ultralytics}
